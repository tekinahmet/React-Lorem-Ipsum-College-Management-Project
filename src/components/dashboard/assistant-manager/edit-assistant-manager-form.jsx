...
const EditAssistantManagerForm = () => {
  ...
  //edit edilecek object yapisi currentrecord olarak geliyor
  ...
  //initial values sabit oldugu icin bir kez set edilir, bunu ortadan kaldırmak icin formik icine enableReinitialize:true kullaniyoruz
  ...
  const onSubmit = async (values) => {
    ...
    try {
      await updateAssistantManager(values); //bununla backend tarafinda kayit olusturuldu
      dispatch(refreshToken()); //listeyi guncellemek icin kullanilir
      dispatch(setOps(null)); //edit formunu kapatmak icin kullanilir
      formik.resetForm(); //formu temizlemek icin kullanilir
      swalAlert("Assistant Manager updated successfully", "success");
    } catch (err) {
      console.log(err);
  ...
  const formik = useFormik({
    ...
    validationSchema,
    onSubmit,
    enableReinitialize: true,//initialValues değiskenini tekrar set edebilmek icin enableReinitialize:true kullaniyoruz
  });
