...
import { refreshToken, setCurrentRecord, setOps } from "../../../store/slices/misc-slice";
...
const ManagerList = () => {
  ...
  const loadData = async () => {
    try {
      const response = await getManagersByPage(lazyState.page, lazyState.rows);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      swalAlert("Manager deleted successfully", "success");
    } catch (err) {
