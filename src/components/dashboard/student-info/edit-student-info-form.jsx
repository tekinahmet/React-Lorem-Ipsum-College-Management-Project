...
const EditStudentInfoForm = () => {
  ...
  const initialValues = {
    ...currentRecord, studentId: currentRecord.studentResponse.userId
  }; //formik te enableReinitialize:true ile daha dinamik hale geliyor
  ...
  const onSubmit = async (values) => {
    ...
    try {
      await updateStudentInfo(values); //bununla backend tarafinda kayit olusturuldu
      ...
      swalAlert("Info updated successfully", "success");
    } catch (err) {
      console.log(err);
