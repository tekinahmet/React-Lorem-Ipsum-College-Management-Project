...
const EditStudentForm = () => {
  ...
  const dispatch = useDispatch(); //merkezi state de degisiklik yapmak icin useDispatch hook kullaniyoruz
  ...
  //her user degisiminde burayı yenilemek icin formik icine enableReinitialize:true kullaniyoruz
  ...
  const onSubmit = async (values) => {
    ...
    try {
      await updateStudent(values); //bununla backend tarafinda kayit olusturuldu
      ...
      swalAlert("Student updated successfully", "success");
    } catch (err) {
      console.log(err);
