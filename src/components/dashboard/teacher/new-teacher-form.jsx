...
const NewTeacherForm = () => {
  ...
  const initialValues = {
    ...
    confirmPassword: "",
    email: "",
    isAdvisorTeacher: false, //boolean oldugu icin kontrol etmeye gerek yok.
    lessonsIdList: [],
  };
  ...
  const onSubmit = async (values) => {
    ...
    try {
      await createTeacher(values); //bununla backend tarafinda kayit olusturuldu
      ...
      swalAlert("Teacher created successfully", "success");
    } catch (err) {
      console.log(err);
